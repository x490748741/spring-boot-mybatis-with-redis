...
//                            map.put("ValidateCode",sex.substring(0, sex.length() - 2 > 0 ? sex.length() - 2 : 1));// 性别
//                        } else {
                            map.put("validateCode",cell.getStringCellValue());// 性别
//                        }
                    } else if (c == 2) {
//                        if (cell.getCellType() == CellType.NUMERIC) {
//                            String age = String.valueOf(cell.getNumericCellValue());
//                            map.put("result", age.substring(0, age.length() - 2 > 0 ? age.length() - 2 : 1));// 年龄
//                        } else {
                            map.put("result", cell.getStringCellValue());// 年龄
//                        }
                    }
